...
export default function UploadDocumentScreen() {
  ...
  const documentTypes: {
  ...
  }[] = [
    {
      ...
      icon: FileText,
      color: '#6366F1',
      description: 'Blood work, test results',
    },
    {
      id: 'prescription',
      label: 'Prescription',
    ...
    },
    {
      ...
      icon: FileHeart,
      color: '#EF4444',
      description: 'Hospital discharge docs',
    },
    {
      id: 'consultation',
          ...
          >
            <View style={styles.syncDots}>
              {[0, 1, 2].map((i) => (
                <View
                  key={i}
                  style={[styles.syncDot, { backgroundColor: colors.accent }]}
                />
              ))}
            </View>
          </MotiView>
      ...
      <View style={[styles.container, { backgroundColor: colors.containerBg }]}>
        ...
        <View style={styles.uploadingContainer}>
          ...
          >
            ...
            <Text
              style={[styles.uploadingStatus, { color: colors.textTertiary }]}
            >
