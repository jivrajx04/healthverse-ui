...
const availableLabs = [
  ...
  },
  {
    ...
    location: 'Hospital Complex, Wing C',
  },
  {
    id: 'lab_4',
    name: 'QuickTest Laboratory',
    location: 'Medical District, Suite 101',
  },
  {
    id: 'lab_5',
    name: 'Premium Diagnostics',
    location: 'Central Hospital, Block B',
  },
];
        ...
        <View style={[styles.content, { backgroundColor: colors.containerBg }]}>
          ...
          <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
                ...
                {selectedLab ? (
                  <View style={styles.selectedLabContent}>
                    <View style={styles.selectedLabInfo}>
                      <Text
                        style={[styles.selectedLabName, { color: colors.text }]}
                      >
                        {selectedLab.name}
                      </Text>
                      <Text
                        style={[
                          styles.selectedLabLocation,
              ...
              <View style={styles.customTestContainer}>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    !customTest.trim() && styles.buttonDisabled,
                  ]}
                >
                  <Text
                    style={[
            ...
            {selectedTests.length > 0 && (
              ...
              >
                <Text
                  style={[styles.selectedSummaryTitle, { color: colors.text }]}
                >
          ...
          <View style={styles.footer}>
            ...
            >
              <LinearGradient
                colors={
                  isValid ? ['#f59e0b', '#d97706'] : ['#334155', '#1e293b']
                }
              ...
              {availableLabs.map((lab) => (
                ...
                >
                  <View style={styles.labOptionContent}>
                    <Text
                      style={[styles.labOptionName, { color: colors.text }]}
                    >
                      {lab.name}
                    </Text>
                    <Text
