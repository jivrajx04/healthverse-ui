...
function TimelineNode({
  ...
  useFrame((state) => {
    ...
    const scale = THREE.MathUtils.lerp(
      1,
      0.5,
      Math.min(distanceFromCenter / 5, 1)
    );
    const opacity = THREE.MathUtils.lerp(
      1,
      0.2,
      Math.min(distanceFromCenter / 8, 1)
    );
              ...
              >
                <View style={styles.docItemContent}>
                  ...
                  <View style={styles.docInfo}>
                    ...
                    <Text
                      style={[styles.docDate, { color: colors.textTertiary }]}
                    >
                      {doc.date}
                    </Text>
                  </View>
