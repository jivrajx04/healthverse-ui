          ...
          <View style={styles.infoGrid}>
            ...
            {doctorData.bio && (
              <View style={styles.bioContainer}>
                <Text style={[styles.bioLabel, { color: colors.textTertiary }]}>
                  Professional Bio
                </Text>
        ...
        >
          ...
          <View style={styles.documentsGrid}>
            ...
            >
              ...
              <Text
                style={[styles.documentDate, { color: colors.textTertiary }]}
              >
                Add document
              </Text>
            </TouchableOpacity>
              ...
              >
                ...
                <View style={styles.editField}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditData({ ...editData, qualification: text })
                    }
                ...
                <View style={styles.editField}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditData({ ...editData, experience: text })
                    }
                ...
                <View style={styles.editField}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditData({ ...editData, hospital: text })
                    }
                ...
                <View style={styles.editField}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditData({ ...editData, consultationFee: text })
                    }
                    placeholder="e.g., $100"
                    placeholderTextColor={colors.textTertiary}
                  />
