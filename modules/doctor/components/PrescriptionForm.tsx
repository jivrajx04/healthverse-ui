...
export default function PrescriptionForm({
  ...
  const isValid =
    diagnosis.trim() && medications.some((med) => med.name.trim());
        ...
        <View style={[styles.content, { backgroundColor: colors.containerBg }]}>
              ...
              {medications.map((med, index) => (
                ...
                >
                  <View style={styles.medicationHeader}>
                    <Text
                      style={[styles.medicationNumber, { color: colors.text }]}
                    >
                      Medicine {index + 1}
                    </Text>
                  ...
                  <Text
                    style={[styles.medLabel, { color: colors.textTertiary }]}
                  >
                    Duration
                  </Text>
                  <TextInput
                    ...
                    value={med.duration}
                    onChangeText={(text) =>
                      updateMedication(med.id, 'duration', text)
                    }
                    placeholder="7 days"
                    placeholderTextColor={colors.textTertiary}
                  />
          ...
          <View style={styles.footer}>
            ...
            >
              <LinearGradient
                colors={
                  isValid ? ['#10b981', '#059669'] : ['#334155', '#1e293b']
                }
