...
import { useLabRequests } from '@/modules/lab/contexts/LabRequestContext';
...
export default function SuccessConfirmationScreen() {
  ...
  const requestId = params.requestId
    ? parseInt(params.requestId as string)
    : null;
            ...
            <View key={file.id} style={styles.reportItem}>
              <View style={styles.reportLeft}>
                ...
                <View style={styles.reportInfo}>
                  ...
                  <Text
                    style={[styles.reportFile, { color: colors.textTertiary }]}
                  >
                    {file.name}
                  </Text>
                </View>
