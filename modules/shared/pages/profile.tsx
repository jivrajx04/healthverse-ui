...
import { ShareProfile } from '@/modules/shared/components/ShareProfile';
import {
  DocumentTimeline3D as DocumentTimeline,
  Document,
} from '@/modules/lab/components/DocumentTimeline3D';
...
export default function ProfileScreen() {
  ...
  const handleUpdatePatient = (
    updatedData: Omit<PatientData, 'id'> & { id?: string }
  ) => {
